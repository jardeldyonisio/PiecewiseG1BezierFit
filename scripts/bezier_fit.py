...
class BezierFitter:
    ...
    def __init__(self):
        '''
        @brief Initialize the BezierFitter with default values.
        '''
        # Results storage
            ...
            for segment in range(num_segments):
                ...
                if end_idx <= total_control_points:
                    ...
                    if segment == 0:
                        ...
                        t_vals = np.linspace(0.0, 1.0, num_points_per_segment)[1:]  # Skip first point to avoid duplication
    ...
    def plot(self):
        ...
        if self.error_history and self.iteration_info:
            ...
            status = '✅ Converged' if self.error_history[-1] < 0.01 else '⚠️ Max iterations reached'
